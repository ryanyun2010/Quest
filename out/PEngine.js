...
export class RenderingEngine {
    ...
    async getVertices(cameraPos, FOVWidth, FOVHeight) {
        let vert = new VertList();
        ;
    ...
    async render(cameraPos, FOVWidth, FOVHeight) {
        if (this.device == null) {
        ...
        console.log(vert2);
        const vertexb = this.device.createBuffer({
    ...
    async renderPass(vertexBuffer) {
        ...
        let passEncoder = this.commandEncoder.beginRenderPass(this.renderPassDescriptor);
...
export class Camera {
    ...
    FOVHeight;
    renderingEngine;
    constructor(position, FOVWidth, FOVHeight, renderingEngine) {
